...
import { BLOB_PATHNAME } from "../scripts/refresh-news";

export const dynamic = "force-dynamic"; // always fetch the latest blob, no caching
...
async function loadNews() {
  try {
    ...
    // No blob written yet (first run hasn't happened), or a transient
    // error — either way, render the empty state rather than crash.
    return null;
  }
}
