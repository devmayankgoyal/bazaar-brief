// lib/summarize.js
//
// Server-side only. Uses GEMINI_API_KEY — must never reach the browser.
// Uses Google's Gemini Flash model, which has a genuinely free tier
// (1,500 requests/day, no credit card, no expiry) — a good fit for a
// pilot. This only ever runs on the scheduled cron job (not per
// visitor), so usage stays flat and well under the free quota
